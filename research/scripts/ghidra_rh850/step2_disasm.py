...
with pyghidra.open_program(
    ...
    print("=== RAW DISASM FUN_000c8f6a (0xc8f60-0xc8fb0) ===")
    a0, a1 = addr(0xc8f60), addr(0xc8fb0)
    ...
    print()
    print("=== RAW DISASM FUN_000c90c4 (0xc90c0-0xc9180) ===")
    a0, a1 = addr(0xc90c0), addr(0xc9180)
    it = listing.getInstructions(program.getAddressFactory().getAddressSet(a0, a1), True)
    for i in it:
        print(hex(int(i.getAddress().getOffset())), i)
