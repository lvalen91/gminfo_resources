...
|8| VIP validation fn @ 0xb67d0 (Y177 4-byte stub vs Y181 906-byte), chain 0xecd84/0xb6652/0xaee28, flag @ RAM 0x3e06 | UNDOC:§8,§10.1 | INFERRED / UNSUPPORTED as measured | doc's own note: only 0xecd84 exists in shipped decompilation; 0xb67d0/0xb6652/0xaee28 from a non-shipped external r2 pass. Not reproducible here | doc flags it; treat asm quotes as un-reproduced |
...
4. **EEPROM "firmware refs" counts (§2/§5) and the 0xb67d0 asm quotes (§8/§10).** UNSUPPORTED / non-reproducible — the doc itself admits this, but the numbers are cited elsewhere as if solid; don't build a flag-testing plan on the exact counts.
